...
class CameraCapture : Fragment(), View.OnClickListener,
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onError(cameraDevice: CameraDevice, error: Int) {
            ...
            this@CameraCapture.activity?.finish()
        }
    ...
    ): View? = inflater.inflate(R.layout.camera_frame, container, false)
    ...
    /**
     * Opens the camera specified by [CameraCapture.cameraId].
     */
    ...
    companion object {
        ...
        @JvmStatic fun newInstance(): CameraCapture = CameraCapture()
    }
}
